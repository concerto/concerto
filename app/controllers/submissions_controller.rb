  ...
  def moderate
    ...
    unless %w[approved rejected].include?(status)
      return respond_to do |format|
        format.html { redirect_back_or_to submissions_path, alert: "Invalid moderation action." }
    ...
    respond_to do |format|
      format.html { redirect_back_or_to submissions_path, notice: "Submission was #{status}." }
