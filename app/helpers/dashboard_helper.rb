module DashboardHelper  
  ...
  def get_activity_item(activity)
    if activity.trackable
      ...
      trackable_name_sym = (activity.trackable_type.downcase + '_name').to_sym
  ...
  def generate_activity_view(activity)
