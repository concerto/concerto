...
Devise.setup do |config|
  ...
  # config.secret_key = '45e68d942f3c3d1e4b8ee5fef4cb95326ede8707c6486791a351a6c53d92b19d0e35cce6e28ef6caeb30f6a2643e7922b42686999c725829281528fd530e3534'
  ...
  # config.pepper = '62bb053ec0081f2eaa4cdcbdacf014a741a7a7d461fc8bcfbb08aacc9c322d0ba38d1a9954a913b309e4246ddff7b969d84deb0a76fd28241f9cdedddc34a193'
    ...
    setup: ->(env) {
      ...
      env["omniauth.strategy"].options.merge!(
        ...
        client_options: {
          ...
          redirect_uri: "#{request.base_url}/users/auth/openid_connect/callback"
        }
      )
    }
