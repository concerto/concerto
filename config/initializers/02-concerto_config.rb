...
if ActiveRecord::Base.connection.table_exists? 'concerto_configs'
  if ConcertoConfig.columns_hash.has_key?("plugin_id")
    ...
    ConcertoConfig.make_concerto_config("motd_html", "", :value_type => "text", :category => 'System', :description => 'HTML to display as the \'message of the day\' on the dashboard and browse page.', :seq_no => 90)
    ConcertoConfig.make_concerto_config("footer_html", "", :value_type => "text", :category => 'System', :description => 'HTML to display on the footer of every page.', :seq_no => 91)
  end
