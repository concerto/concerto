...
ActiveRecord::Schema.define(:version => 20131216202517) do
  ...
  create_table "fields_kinds", :id => false, :force => true do |t|
    t.integer "field_id"
    t.integer "kind_id"
  end

  add_index "fields_kinds", ["field_id", "kind_id"], :name => "index_fields_kinds_on_field_id_and_kind_id"
